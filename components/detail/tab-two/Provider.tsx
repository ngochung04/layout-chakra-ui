...
const Provider = () => {
  ...
  return (
    <>
      <Flex my="0.5rem" direction={{ base: "column", md: "row" }}>
        <Box w={{ base: "100%", md: "70%" }} position="relative">
          ...
          <Collapse startingHeight="3rem" in={isOpen}>
            <Text fontSize="md">
              ...
              constantly to include improvements from Google research teams,
              which results in better translations and new languages and
              language pairs.
            </Text>
          </Collapse>
          <Box
